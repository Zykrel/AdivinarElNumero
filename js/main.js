...
const adivinarNumero = () => {
    ...
    if (numero == numeroAleatorio) {
        document.getElementById("resultado").innerHTML = `¡Ganaste! <br/> Para continuar elija otro número <br/> <br/> <img src="./assets/img/win.gif"/>`;
        ...
        puntajeA -= 1;
        if (puntajeA == 0) {
            document.getElementById("resultado").innerHTML = `Perdiste <br/> El numero era: ${numeroAleatorio} <br/> <br/> <img src="./assets/img/lose.gif"/>`;
            puntajeA = 10;
            cambiarNumeroA();
        ...
        puntajeA -= 1;
        if (puntajeA === 0) {
            document.getElementById("resultado").innerHTML = `Perdiste <br/> El numero era: ${numeroAleatorio} <br/> <br/> <img src="./assets/img/lose2.gif"/>`;
            puntajeA = 10;
